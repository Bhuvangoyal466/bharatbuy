                ...
                <div className="container px-5 py-24 mx-auto">
                    ...
                    <div className="text-center mb-16">
                        ...
                        <p className="text-gray-600 text-lg max-w-2xl mx-auto">
                            Discover our curated collection of premium quality
                            t-shirts, crafted with love and designed for comfort
                            and style.
                        </p>
                    </div>
                                                    ...
                                                    {products[product].size &&
                                                        products[
                                                            ...
                                                            (s, index) => (
                                                                <span
                                                                    key={index}
                                                                    className="px-3 py-1 text-sm border border-gray-300 text-gray-700 rounded-full hover:border-nykaa-primary hover:text-nykaa-primary transition-colors duration-200"
                                                                >
                                                                    {s}
                                                                </span>
                                                            )
                    ...
                    {Object.keys(products).length === 0 && (
                        <div className="text-center py-20">
                            ...
                            <p className="text-gray-600 mb-8">
                                We're working on bringing you amazing t-shirts.
                                Check back soon!
                            </p>
                            <Link href="/">
